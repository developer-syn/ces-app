                    ...
                    <div class="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                        ...
                        <div class="relative">
                            <input type="text" name="search" value="{{ request('search') }}" id="searchInput"
                                placeholder="Search students name or LRN"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($students as $student)
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="border-t px-6 py-4">{{ $student->status }}</td>
                                    <td class="px-6 py-4">
                                            ...
                                            <div x-show="open" @click.away="open = false"
                                                ...
                                                @if (auth()->user()->role === 'teacher')
                                                    ...
                                                    @if ($student->status === 'transferee')
                                                        <!-- if Transfer Student it will show this button -->
                                                        <div class="py-2 px-1 space-y-1">
                                                            <a href="{{ route('teacher.transfer-students.create', $student->id) }}"
                                                                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 rounded-md group">
                                                                <svg class="w-5 h-5 mr-2 text-blue-600" fill="none"
                                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    {{-- if the student is transferree where year level is greater than one, the level of
                                                    where there is no record should display so that the teacher can add
                                                    attendance and core values for that year level --}}
                                                    <div class="py-2 px-1 space-y-1">
                                                        <div
