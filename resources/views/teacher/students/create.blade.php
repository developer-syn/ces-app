                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="number" id="LRN_num" name="LRN_num" required
                                    ...
                                    placeholder="Enter LRN number" value="{{ old('LRN_num') }}">
                                @error('LRN_num')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" id="birthdate" name="birthdate" required
                                    ...
                                    max="{{ date('Y-m-d', strtotime('-5 years')) }}" value="{{ old('birthdate') }}"
                        ...
                        <div>
                            ...
                            <select id="status" name="status" required
                                ...
                                <option value="graduated" {{ old('status') == 'graduated' ? 'selected' : '' }}>
                                    Graduated</option>
                                <option value="transferee" {{ old('status') == 'transferee' ? 'selected' : '' }}>
                                    Transferee</option>
                            </select>
                        </div>
