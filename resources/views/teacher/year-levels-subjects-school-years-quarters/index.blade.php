                                                ...
                                                <div class="flex gap-2">
                                                    <form action="{{ route('teacher.year-levels.update', $yearLevel->id) }}"
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               class="w-10 rounded-md border-gray-300 text-sm"
                                                               required>
                                                        <button type="submit"
                                                    ...
                                                    <form action="{{ route('teacher.year-levels.destroy', $yearLevel->id) }}"
                                                          method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                    ...
                    <div class="p-6">
                        ...
                        <div class="overflow-x-auto rounded-lg border">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Quarters</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Actions</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200">
