...
@if (isset($student->year_level_id) && $student->year_level_id === 3)
    <div class="overflow-x-auto">
        ...
        <table class="w-full border-collapse border border-gray-800">
            <thead>
                <tr>
                    <th class="border border-gray-800 p-2 text-left" rowspan="2" style="width: 30%;">
                        Learning
                        Areas</th>
            ...
            <tbody>
                ...
                @foreach ($subjects as $subject)
                    ...
                    @if ($subject === 'MAPEH')
                        <tr>
                            <td class="border border-gray-800 p-2">&nbsp;&nbsp;&nbsp;MAPEH</td>
                            @for ($q = 1; $q <= 4; $q++)
                                <td class="border border-gray-800 p-2 text-center">{{ $mapehAverages[$q] ?? '' }}</td>
                            @endfor
                            <td class="border border-gray-800 p-2 text-center">{{ $mapehFinal }}</td>
                    ...
                    <tr>
                        ...
                        @for ($q = 1; $q <= 4; $q++)
                            <td class="border border-gray-800 p-2 text-center">{{ $quarters[$q] ?? '' }}</td>
                        @endfor
                        <td class="border border-gray-800 p-2 text-center">{{ $quarters['final'] ?? '' }}</td>
                        <td class="border border-gray-800 p-2 text-center">
                ...
                <tr>
                    <td class="border border-gray-800 p-2 font-bold">&nbsp;&nbsp;&nbsp;General Average</td>
                    @for ($q = 1; $q <= 4; $q++)
                        <td class="border border-gray-800 p-2 text-center font-bold">{{ $quarterlyAverages[$q] }}</td>
                    @endfor
                    <td class="border border-gray-800 p-2 text-center font-bold">{{ $finalGeneralAverage }}</td>
                ...
                <tr>
                    <td class="border border-gray-800 px-4 p-2">Remedial Classes</td>
                    <td colspan="6" class="border border-gray-800 px-2 p-2">Date Conducted: ______________ to ______________</td>
                </tr>
                <tr>
                    <th class="border border-gray-800 p-2">Learning Areas</th>
                    <th class="border border-gray-800 p-2">Final Rating</th>
                    <th colspan="2" class="border border-gray-800 p-2">Remedial Class Mark</th>
                    <th colspan="2" class="border border-gray-800 p-2">Recomputed Final Grade</th>
                    <th class="border border-gray-800 p-2">Remarks</th>
                </tr>
                <tr>
                    <td class="border border-gray-800 p-2">&nbsp;</td>
                    <td class="border border-gray-800 p-2"></td>
                    <td colspan="2" class="border border-gray-800 p-2"></td>
                    <td colspan="2" class="border border-gray-800 p-2"></td>
                    <td class="border border-gray-800 p-2"></td>
                </tr>
                <tr>
    ...
    <div class="overflow-x-auto">
        ...
        <div class="border-1 border-gray-800 overflow-hidden">
            <table class="w-full">
                <thead>
                    <tr>
                        <td colspan="2" class="border border-gray-800 p-2">Remedial Classes</td>
                        <td colspan="3" class="border border-gray-800 p-2">Date Conducted: ___________________ to
